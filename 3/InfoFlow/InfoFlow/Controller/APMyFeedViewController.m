...
- (void)setupUI {
    ...
    [_fpsLabel makeConstraints:^(MASConstraintMaker *make) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    __block APMyFeedLayout *layout = self.layouts[indexPath.row];
    cell.layout = layout;
    cell.expandBlock = ^(BOOL isExpand) {
        APMyFeed *feed = layout.feed;
        feed.expand = !isExpand;
        layout.feed = feed;
